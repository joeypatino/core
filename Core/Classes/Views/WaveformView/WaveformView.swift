//
// Copyright 2013 - 2017, William Entriken and the WaveformView contributors.
//
import UIKit
import MediaPlayer
import AVFoundation
...
open class WaveformView: UIView {
    ...
    //TODO: make this public after reconciling WaveformView.WaveformType and WaveformType
    var waveformRenderType: WaveformType {
        get {
            switch waveformType {
    ...
    func setup() {
        waveformType = .logarithmic(noiseFloor: noiseFloor)
    ...
    func renderWaveform() {
        ...
        let renderFormat = WaveformRenderFormat(type: waveformRenderType, wavesColor: .black, scale: desiredImageScale)
...
//TODO: make this public after reconciling WaveformView.WaveformType and WaveformType
public enum WaveformType: Equatable {
    ...
    public static func ==(lhs: WaveformType, rhs: WaveformType) -> Bool {
        switch lhs {
        case .linear:
            if case .linear = rhs {
                return true
...
@objc public protocol WaveformViewDelegate: NSObjectProtocol {
    ...
    @objc optional func waveformDidBeginPanning(_ waveformView: WaveformView)

    /// The panning gesture ended
    @objc optional func waveformDidEndPanning(_ waveformView: WaveformView)
