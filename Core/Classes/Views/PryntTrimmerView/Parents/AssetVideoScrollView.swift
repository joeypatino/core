...
class AssetVideoScrollView: UIScrollView {
    ...
    public var maxDuration: Double = .greatestFiniteMagnitude
    ...
    private func addThumbnailViews(_ count: Int, size: CGSize) {
        ...
        for index in 0..<count {
            ...
            if index == 0 {
                thumbnailView.layer.maskedCorners = [.layerMinXMinYCorner, .layerMinXMaxYCorner]
                thumbnailView.layer.cornerRadius = 4
            }
            if index == count-1 {
                thumbnailView.layer.maskedCorners = [.layerMaxXMinYCorner, .layerMaxXMaxYCorner]
                thumbnailView.layer.cornerRadius = 4
            }
