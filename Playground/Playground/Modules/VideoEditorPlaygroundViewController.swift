...
//    lazy var timeline = AssetTimelineView()
//    lazy var composition = Composition() {
//        didSet { updateComposition() }
//    }
//    lazy var videoPlayerViewController = VideoPlayerViewController(playerItem: composition.videoLayers.isEmpty ? AVPlayerItem(asset: AVComposition()) : composition.playerItem)
...
//        guard composition.videoLayers.count > 0 else { return }
